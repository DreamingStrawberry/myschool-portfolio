...
<details>
<summary><b>Student (학생)</b></summary>
<br>
...
- **phone**: 연락처
- **birth**: 생년월일
- **delstate**: 삭제 상태 (0: 활성, 1: 삭제)

</details>

<details>
<summary><b>Teacher (교사)</b></summary>
<br>

- **id**: 고유 식별자
- **level**: 권한 레벨 (100: 관리자, 80: 담임, 50: 일반 교사)
- **ban**: 담임 반 (있는 경우)
- **userid**: 로그인 아이디
- **pwd**: 암호화된 비밀번호
- **name**: 교사 이름
...
<details>
<summary><b>Sungjuk (성적)</b></summary>
<br>

- **id**: 고유 식별자
- **kor, eng, mat, sci, mus**: 각 과목 점수
- **ban**: 반
- **bunho**: 번호
- **name**: 학생 이름
- **tot**: 총점
...
<details>
<summary><b>Community (게시판)</b></summary>
<br>
...
- **content**: 게시글 내용
- **writeday**: 작성일
- **cla**: 게시판 분류 (notice: 공지사항, board: 자유게시판, data: 자료실)
- **readnum**: 조회수
- **ofname**: 원본 파일명
- **sfname**: 저장 파일명
- **userid**: 작성자 ID
...
<details>
<summary><b>1️⃣ 소스코드 다운로드</b></summary>
<br>
...
<details>
<summary><b>2️⃣ 데이터베이스 설정</b></summary>
<br>
...
`src/main/resources/application.properties` 파일을 열고 필요한 설정을 수정합니다:
...
<details>
<summary><b>디렉토리 구조 살펴보기</b></summary>
<br>
...
│   │       │   ├── layout/              # 레이아웃 템플릿
│   │       │   └── views/               # 페이지별 뷰 템플릿
│   │       └── application.properties   # 애플리케이션 속성
│   └── test/                            # 테스트 코드
│       └── java/
│           └── com/
│               └── example/
